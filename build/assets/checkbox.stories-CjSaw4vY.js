import{j as e}from"./index-DLWdPwQt.js";import{g as f,c as j,C as y,a as C,b as l}from"./variantSelector-CR2HWpnV.js";const s=({id:t="checkDefault",label:r=null,className:v="",value:i="",onChange:o,...m})=>{var d,a,h;const c=f(),n=c?(d=c==null?void 0:c.Checkbox)==null?void 0:d.container:"form-check",b=c?(a=c==null?void 0:c.Checkbox)==null?void 0:a.input:"form-check-input",k=c?(h=c==null?void 0:c.Checkbox)==null?void 0:h.label:"form-check-label",x=u=>{o&&o(u)};return e.jsxs("div",{className:n,children:[e.jsx("input",{className:b,type:"checkbox",value:i,id:t,...m,onChange:x}),e.jsx("label",{className:k,htmlFor:t,children:r})]})},p=()=>e.jsxs("main",{style:j,children:[e.jsx("h1",{children:"Checkbox"}),e.jsx("span",{style:C,children:y}),e.jsxs("div",{style:{marginBottom:"1rem"},children:[e.jsx(s,{id:"check-default",label:"Default checkbox",value:"remember-me",onChange:()=>{alert("Checkbox clicked")}}),e.jsx(l,{code:`<Checkbox
  id="check-default"
