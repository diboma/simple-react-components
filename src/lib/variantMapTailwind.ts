...
export default {
  ...
  Spinner: {
    text: `sr-only`,
    spinner: `animate-spin inline-block border-blue-600 border-t-transparent rounded-full`,
    borderSmall: `border-2`,
    borderMedium: `border-4`,
    borderLarge: `border-6`,
    ...
    light: `border-gray-100 border-t-transparent`,
